...
const onLoad = () => {
    ...
    overlay.style.height = `${(window.innerWidth * bkgh / bkgw)}px`; 
}
const onResize = () => {
    container.style.width = `${window.innerWidth}px`;
    container.style.height = `${(window.innerWidth * bkgh / bkgw)}px`;
    map.style.width = `${window.innerWidth}px`;
    map.style.height = `${(window.innerWidth * bkgh / bkgw)}px`;
    overlay.style.width = `${window.innerWidth}px`;
    overlay.style.height = `${(window.innerWidth * bkgh / bkgw)}px`;
};
const onBtnClick = (e) => {
